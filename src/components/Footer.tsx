        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-20 gap-x-12 pb-24 border-b border-white/5">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col gap-5">
              ...
              <a href="https://wa.me/2347065364401" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-[11px] uppercase tracking-[0.2em] text-neutral-400 hover:text-brand-beryl transition-all">
