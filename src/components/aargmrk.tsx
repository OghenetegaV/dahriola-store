Keeping everything else the way it is, the client doesn't what the logo to turn white at all. She wants it to always maintain it original colour. Also add the wishlist to the right side.                                                   "use client";
