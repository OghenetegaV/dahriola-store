    ...
    <section className="relative w-full h-[90vh] min-h-[600px] flex items-end overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 w-full h-full">
        <Image
          ...
          fill
          priority
          className="h-full w-full object-cover object-center md:object-[center_28%] brightness-75"
        />
            ...
            >
              ...
              >
                <Image
                  ...
                  alt="zoom-lens"
                  fill
                  className="object-cover object-center md:object-[center_28%] brightness-110"
                />
              </div>
            </motion.div>
